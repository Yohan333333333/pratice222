...
<body>
 ...
 <form action = "HostLogin.do" method="post">
 <table width="1400" height="650">
  <tr>
   <td width="100%" height="10%"><span style="padding-left: 160px"><img
    src="" width="290" height="100" border="0"
    align="middle"></span>&nbsp; <b>호핑 호스트 회원가입</b>
    <br>
    <hr>
   </td>
  </tr>
  <tr>
   ...
   <p align="left">
   <span style="padding-left: 160px">Hoping 약관동의</span>
   </p>
   <br>
   <textarea
...
<a href="webapp/HostRegMapApi.jsp">
<b>다음</b>
